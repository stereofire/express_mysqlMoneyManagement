...
var user = {
    ...
    // 商户集团信息上传
    TgroupUpload: 'INSERT INTO 商户集团信息表(集团编号,集团名称,备注,状态) VALUES(?,?,?,?)',

    // 商户信息
    TcorpInfo: 'select * from 商户信息表',
    // 商户信息上传
    TcorpUpload: 'INSERT INTO 商户信息表(商户代码,商户名称,商户银行账号,商户对账联系人,商户对账联系人电话,商户对账联系人邮箱,商户对账联系人备注,结算类型,是否支持退货,商户类型,集团编号,商户地址,状态) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)',
    ...
    // 教材计划上传
    TcoursePlansUpload: 'INSERT INTO 教材计划(教材代码,学院,单价,专业,学期,课程名,教材名,出版社) VALUES(?,?,?,?,?,?,?,?)',
